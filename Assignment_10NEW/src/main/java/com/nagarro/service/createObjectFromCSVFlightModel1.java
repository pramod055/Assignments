...
/**
 * @author pramodyadav
 *this class is use to create a FlightModel Class object after setting attribute
 */
public class createObjectFromCSVFlightModel1 {
	
	public FlightModel getFlightModelObjectFromCSVLine(String CSVCurrentLine)
	{
		/**
		 * @return a FlightModel class object
		 */
        FlightModel ob=null;
		try
		{
