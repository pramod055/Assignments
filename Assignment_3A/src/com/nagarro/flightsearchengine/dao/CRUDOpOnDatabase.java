...
public class CRUDOpOnDatabase 
{
	...
	public List<FlightDetails> SearchFlightIntoDatabaseAnd_sort(UserInputDetails userInputObject ) throws ParseException, exception
	{
		/**
		...
		try
		{
			...
			System.out.println("ssize ::" + resultantflightsList.size());
			tx.commit();
		}
