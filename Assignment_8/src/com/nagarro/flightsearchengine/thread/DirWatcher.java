...
/**
 * @author pramodyadav
 *class use for polling the csv file
 */
...
public abstract class DirWatcher extends TimerTask {
	  ...
	  public final void run(){
		  try{
			  HashSet<File> checkedFiles = new HashSet<File>();
			     ...
			     */
			    Set<File> ref = ((HashMap<File, Long>)dir.clone()).keySet();//make a set for all keys from map
	  ...
	  protected abstract void onChange( File file, String action ) throws exception;
	}
